...
const queryResults = ["apples", "bananas", "oranges", "soccer", "dolphins", "cats", "iPads"];
...
const Part8 = () => {
  ...
  return (
    <Layout>
      ...
      {/* <Link title="The Hunter Envoy" href="https://thehunterenvoy.wordpress.com" className={classes.coloredLink}>The Hunter Envoy</Link> */}
      <Link title="My article" href = "http://localhost:8000/articles/2021/07/08/doe-looks-to-expand-cs-education" >My Article</Link>
      </div>
